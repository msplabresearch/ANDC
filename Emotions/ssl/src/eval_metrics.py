...
def scores(results, truths):
    ...
    print('F1 Ma = {:5.3f}'.format(f1ma))
    print('F1 Mi = {:5.3f}'.format(f1mi))

    print('Pre Ma = {:5.3f}'.format(pre_ma))
    print('Pre Mi = {:5.3f}'.format(pre_mi))

    print('Rec Ma = {:5.3f}'.format(re_ma))
    print('Rec Mi = {:5.3f}'.format(re_mi))