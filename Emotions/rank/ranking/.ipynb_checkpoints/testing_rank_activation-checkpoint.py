...
model_path = os.path.join(file_dir, 'Models','LSTM_model[epoch20-batch128-lr5e-05]_RnnAttenVec_Act_weights.h5')
...
print("RankNet Activation inference: ")
for filename, f_info in tqdm(audio_files.items()):
    ...
    f_info['ranknet_activation_pred'] = float(pred[0][0])
...
print("Finished RankNet Activation")
