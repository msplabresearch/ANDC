...
model_path = os.path.join(file_dir, 'Models','LSTM_model[epoch2-batch1-lr1e-06]_RnnAttenVec_val_weights.h5')
...
# test_file_path = getPaths_test(label_dir)
...
print("Ladder Pref Val inference: ")
for filename, f_info in tqdm(audio_files.items()):
    ...
    f_info['ladderpref_valence_pred'] = float(pred[0])
