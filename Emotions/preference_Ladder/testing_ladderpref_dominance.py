...
model_path = os.path.join(file_dir, 'Models','LSTM_model[epoch8-batch1-lr1e-06]_RnnAttenVec_Dom_weights.h5')
...
print("Ladder Pref Dom inference: ")
for filename, f_info in tqdm(audio_files.items()):
    ...
    f_info['ladderpref_dominance_pred'] = float(pred[0])
